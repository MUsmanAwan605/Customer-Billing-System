									...
									<div class="form-body">
										<form class="row g-3" method="POST" action="{{ route('login') }}">
											...
											<div class="col-12">
                                                ...
                                                @enderror" id="inputEmailAddress" name="email" :value="old('email')" placeholder="Email@example.com">
                                                @error('email')
                                                <span class="text-danger mt-2">{{ $message }}</span>
                                                @enderror
                                            </div>
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label @error('password') is-invalid

                                                @enderror" :value="__('Password')">Password</label>
