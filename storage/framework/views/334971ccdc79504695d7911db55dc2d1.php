                   ...
                   <div class="d-flex align-items-center">
                       <div>
                        <a href="<?php echo e(route('admin.customer.index')); ?>">
                            <p class="mb-0 text-secondary">Coustomer</p>
                        </a>
                   ...
                   <div class="d-flex align-items-center">
                       <div>
                        <a href="<?php echo e(route('admin.billing.index')); ?>">
                            <p class="mb-0 text-secondary">Billing</p>
                        </a>
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\biling\resources\views/admin/index.blade.php ENDPATH**/ ?>